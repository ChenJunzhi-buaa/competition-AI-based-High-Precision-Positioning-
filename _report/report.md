...
| 46-1 | | | 46跑一半断电了，在46的基础上，重新跑，另外**关掉了可复现设置** |99.82658409488 | 99.83500137379 |769epochs |
| 47 | | | | | | | 在44-1的基础上，**外加分类loss** |
| 47-1 | | | | | | | 在47的基础上，验证集只用回归损失 |
| 48 | | | | | | | 在47-1(3042epochs)的基础上（作为预训练模型），**利用分类阈值(设为0.99)self-training 十轮，每轮500epochs**, batch size要改为256 |
| 48-1 | | | | | | | 在48的基础上，改为每轮5个epochs.初始学习率改为1e-4 |