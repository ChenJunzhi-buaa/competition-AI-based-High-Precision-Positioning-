...
| **59-4-4-4** | | | | | | | **num_workers从默认的0改为4，看能否提速？？？？？** ,**以及用设置进程来释放显存的写法**, **自适应阈值第二版**，集成弱模型1-12，15-23，不集成集成模型| | 最佳集成测试分数为98.85343933105469|
...
| 59-12 | | | | | | | 基于59-6,训mobilenet_v2| | 最佳集成测试分数为应该和59-6一样|
...
| 59-25 | | | | | | | 59-4-4-4的基础上，集成集成模型59-1，59-4，59-4-4, 59-6,59-24-24, 训resnet18 |98.87471451966(397epochs)/**98.90117509282(531epochs)**/98.88146800(3749epochs) | 最佳测试集分数98.99073028564453**好快呀**|
...
| 59-25-25-25-25-25 | | | | | | |在59-25的基础上，集成1-12，15-23，101-103，不集成已有的集成模型|)
| 59-26 | | | | | | | 59-25的基础上，训resnet34 | | **好快呀**|
...
| 61-5-5-5-5(**61-5-2-2-2**) | | | 61-5基础上，bs改为512 | **99.87930986999(2961epochs)**| **99.89139749225** | 11s/epochs |
| 61-5-5-5-5-5(61-5-2-2-2-2) |99.86218121179(1998epochs) |99.86810572914 | 61-5基础上，bs改为1024 |99.86218121179|  |14s/epochs(**与61-5，61-5-2-2-2对比发现，bs越大，也不一定更快**)  |
