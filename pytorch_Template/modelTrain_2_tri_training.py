...
class SSL():
    ...
    def train(self, train_X, train_Y, model, TOTAL_EPOCHS=50, BATCH_SIZE=100, LEARNING_RATE=0.001,
    ...
    def formal_train(self, epoch, num):
        ...
        pseudo_label_data1, pseudo_label1 = self.generate_pseudo_label(self.F2, self.F3, self.unlabel_data,
                                                                       percentage=(epoch + 1) / num)
        ...
        pseudo_label_data2, pseudo_label2 = self.generate_pseudo_label(self.F1, self.F3, self.unlabel_data,
                                                                       percentage=(epoch + 1) / num)
        ...
        pseudo_label_data3, pseudo_label3 = self.generate_pseudo_label(self.F1, self.F2, self.unlabel_data,
                                                                       percentage=(epoch + 1) / num)
